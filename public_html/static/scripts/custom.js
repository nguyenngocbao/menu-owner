...
document.addEventListener('DOMContentLoaded', () => {
    ...
    var pwaName = "Emenu"; //Local Storage Names for PWA
    ...
    function init_template(){
        ...
        highlightData.forEach(el => el.addEventListener('click', e =>{
            ...
            loadHighlight.href =  '/static/styles/highlights/highlight_' + highlight +'.css';
        ...
        if(rememberHighlight){
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href =  '/static/styles/highlights/highlight_' + rememberHighlight +'.css';
            ...
            loadHighlight.className = "page-highlight";
            loadHighlight.type = "text/css";
            loadHighlight.href =  '/static/styles/highlights/highlight_' + defaultHighlight[1] +'.css';
            if(!document.querySelectorAll('.page-highlight').length){
                document.getElementsByTagName("head")[0].appendChild(loadHighlight);
